  ...
  render: function() {
    return (
      React.createElement("div", {className: "comment"}, 
        ...
        React.createElement("a", {href: this.props.url}, this.props.url)
      )
    );
  }
});
...
var CommentList = React.createClass({displayName: "CommentList",
  render: function() {
    var commentNodes = this.props.data.map(function(comment) {
      return (
        React.createElement(Comment, {author: comment.title, url: comment.url})
      );
    });
    return (
...
React.render(React.createElement(CommentBox, {url: "https://qiita.com/api/v2/items", pollInterval: 100000}), document.getElementById('content'));
