...
var Text1 = React.createClass({displayName: "Text1",
  getInitialState() {
    return {
  ...
  render() {
    return (
      React.createElement("div", null, 
        React.createElement("p", null, this.state.textValue), 
        React.createElement("input", {type: "text", value: this.state.textValue, onChange: this.changeText})
      )
    );
  }
});

var Text2 = React.createClass({displayName: "Text2",
  getInitialState() {
    return {
      textValue: "initial value"
    };
  ...
  render() {
    return (
      React.createElement("div", null, 
        React.createElement("p", null, this.state.textValue), 
        React.createElement("input", {type: "text", ref: "inputText", defaultValue: "initial value"}), 
        React.createElement("button", {onClick: this.changeText}, "change")
      )
    );
  }
});

React.render(React.createElement(Text2, null), document.getElementById('content'));
